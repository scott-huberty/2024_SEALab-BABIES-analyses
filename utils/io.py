...
def get_gestational_age_df(want_age="newborn"):
    ...
    df_ages["study_id"] = df_ages["study_id"].apply(lambda study_id: "sub-" + str(study_id))
...
def get_brainvol_df(fname, zscore=False):
    ...
    id_col = ["study_id"]
    brain_cols = [
        "BrainSegVolNotVent", "SubCortGrayVol", "CortexVol", "TotalGrayVol", "CerebralWhiteMatterVol"
        ]
